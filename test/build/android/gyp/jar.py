...
def Jar(class_files, classes_dir, jar_path, manifest_file=None,
    ...
    with build_utils.TempFile(suffix=".sources") as jar_sources_file:
        ...
        with tempfile.NamedTemporaryFile(suffix='.jar') as tmp_jar:
            ...
            build_utils.WriteSourcesFile(class_files_rel, jar_sources_file)
            jar_cmd.append("@" + jar_sources_file)
